/*
 * Proxy Bridge - Mzee Kobe Store
 * Based on proxy3.js by PANCHO7532 - P7COMUnications LLC (c) 2021
 * Modified for Mzee Kobe Store VPN Panel
 */
...
server.on('connection', function(socket) {
    var packetCount = 0;
    socket.write("HTTP/1.1 101 MzeeKobe WebSocket Started\r\nContent-Length: 1048576000000\r\n\r\n", function(err) {
        if(err) {
...
server.listen(mainPort, function(){
    console.log("[INFO] Mzee Kobe Proxy Bridge started on port: " + mainPort);
